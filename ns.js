(function(global) {
    ...
    // Create the LP namespace to the 'this' object and assign the ns() method.
    createNamespace('LP', this).ns = function(namespace, containerObject) {
        return createNamespace(namespace, (containerObject || global));
    };
